...
### Added
- **Database Dumps** for cross-language support:
  ...
  - MongoDB collections (`db/mongodb/*.json`)
- Database schema with proper foreign keys and indexes
- `npm run generate:db` script to regenerate dumps
- Documentation with import instructions and example queries

### Benefits
- Use data in PHP, Python, Java, Go, Ruby, C#, etc.
